...
return {
    ...
    -- dogs
    {
        ...
        npcpetprice = 200,
        skins = {0, 1, 2}, -- change outfit animal, 
    ...
    },
    {
        ...
        npcpetprice = 50,
        skins = {0, 1, 5, 6}, -- change outfit animal, 2, 3, 4 have collar by default, 
    ...
    },
    {
        ...
        npcpetprice = 100,
        skins = {0, 1, 2, 3}, -- change outfit animal, 2, 3, 4 have collar by default,
    ...
    },
    {
        ...
        npcpetprice = 100,
        skins = {0}, -- change outfit animal, 2, 3, 4 have collar by default,
    ...
    },
    {
        ...
        npcpetprice = 150,
        -- outfit = 'mp_dogbluetickcoonhound_01_collar_001',
        skins = {0, 1, 2, 3, 4}, -- max change outfit animal, range 0 - 4, and 5 is for bad care or bad pet need veterinary?, 
    ...
    -- dogs
    {
        ...
        npcpetprice = 200,
        skins = {0, 1, 2 }, -- max change outfit animal range 0-2, and 5-7 have collar, 4 is for bad care or bad pet need veterinary?, 
    ...
    },
    {
        ...
        npcpetprice = 500,
        skins = {0, 1, 2}, -- max change outfit animal range 0-2, 
    ...
    },
    {
        ...
        npcpetmodel = 'a_c_dogcatahoulacur_01',
        npcpetprice = 50,
        skins = {1, 5, 6}, -- change outfit animal, 2, 3, 4 have collar by default, 
        label = locale('dog_catahoulacur'),
        type = {'canis'},
        stableid = 'tumbleweed',
    },
    {
        ...
        npcpetmodel = 'a_c_dogbluetickcoonhound_01',
        npcpetprice = 150,
        skins = {0, 1, 2, 3, 4}, -- change outfit animal range 0 - 4, and 5 is for bad care, 
        label = locale('dog_bluetickcoonhound'),
        type = {'canis'},
        stableid = 'tumbleweed',
    },
    {
        ...
        npcpetmodel = 'a_c_doglab_01',
        npcpetprice = 100,
        skins = {0, 1, 2, 3}, -- change outfit animal,
        type = {'canis'},
        label = locale('dog_lab'),
        stableid = 'tumbleweed',
    },
